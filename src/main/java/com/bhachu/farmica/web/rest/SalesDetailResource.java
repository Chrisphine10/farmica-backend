...
public class SalesDetailResource {
    ...
    public ResponseEntity<List<SalesDetailDTO>> getAllSalesDetails(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "false") boolean eagerload
    ) {
        log.debug("REST request to get a page of SalesDetails");
        Page<SalesDetailDTO> page;
        if (eagerload) {
            page = salesDetailService.findAllWithEagerRelationships(pageable);
        } else {
            page = salesDetailService.findAll(pageable);
        }
