...
public class BatchDetailResource {
    ...
    public List<BatchDetailDTO> getAllBatchDetails(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all BatchDetails");
        return batchDetailService.findAll();
    }
