...
public class VariableDataResource {
    ...
    public ResponseEntity<List<VariableDataDTO>> getAllVariableData(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of VariableData");
        Page<VariableDataDTO> page = variableDataService.findAll(pageable);
