package com.bhachu.farmica.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.bhachu.farmica.service.EmailAlreadyUsedException ||
            ex instanceof com.bhachu.farmica.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.bhachu.farmica.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.bhachu.farmica");
    }
}
