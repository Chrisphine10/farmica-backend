...
import com.bhachu.farmica.service.RegionService;
...
/**
 * REST controller for managing {@link com.bhachu.farmica.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
     ...
     */
    @GetMapping("/regions")
    public List<RegionDTO> getAllRegions(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
