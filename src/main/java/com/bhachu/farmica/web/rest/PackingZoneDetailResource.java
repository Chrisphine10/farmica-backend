...
public class PackingZoneDetailResource {
    ...
    public ResponseEntity<List<PackingZoneDetailDTO>> getAllPackingZoneDetails(
        @org.springdoc.core.annotations.ParameterObject Pageable pageable,
        @RequestParam(required = false, defaultValue = "false") boolean eagerload
    ) {
        log.debug("REST request to get a page of PackingZoneDetails");
        Page<PackingZoneDetailDTO> page;
        if (eagerload) {
            page = packingZoneDetailService.findAllWithEagerRelationships(pageable);
        } else {
            page = packingZoneDetailService.findAll(pageable);
        }
