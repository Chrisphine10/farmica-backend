...
/**
 * REST controller for managing {@link com.bhachu.farmica.domain.Style}.
 */
@RestController
@RequestMapping("/api")
public class StyleResource {
    ...
    public ResponseEntity<List<StyleDTO>> getAllStyles(
        ...
        Page<StyleDTO> page;
        if (eagerload) {
            page = styleService.findAllWithEagerRelationships(pageable);
        } else {
            page = styleService.findAll(pageable);
        }
