...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WAREHOUSEDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_WAREHOUSEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_WAREHOUSEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_WAREHOUSEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_WAREHOUSEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_WAREHOUSEDETAIL actions', async () => {
      const expectedActions = [
        {
