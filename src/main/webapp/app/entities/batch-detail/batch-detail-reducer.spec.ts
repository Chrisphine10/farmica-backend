...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BATCHDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_BATCHDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BATCHDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BATCHDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BATCHDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BATCHDETAIL actions', async () => {
      const expectedActions = [
        {
