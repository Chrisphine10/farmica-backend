...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './packing-zone-detail.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKINGZONEDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKINGZONEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKINGZONEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKINGZONEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKINGZONEDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKINGZONEDETAIL actions', async () => {
      const expectedActions = [
        {
