  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="farmicaApp.region.home.createOrEditLabel" data-cy="RegionCreateUpdateHeading">
            <Translate contentKey="farmicaApp.region.home.createOrEditLabel">Create or edit a Region</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('farmicaApp.region.name')}
                id="region-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('farmicaApp.region.code')}
                id="region-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('farmicaApp.region.user')}
                type="select"
                required
              >
                <option value="" key="0" />
