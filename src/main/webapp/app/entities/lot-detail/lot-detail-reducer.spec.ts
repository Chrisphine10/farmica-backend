...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOTDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOTDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOTDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOTDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOTDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOTDETAIL actions', async () => {
      const expectedActions = [
        {
