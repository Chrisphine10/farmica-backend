...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './style.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STYLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_STYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STYLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STYLE actions', async () => {
      const expectedActions = [
        {
