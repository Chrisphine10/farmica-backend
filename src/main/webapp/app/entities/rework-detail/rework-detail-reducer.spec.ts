...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REWORKDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_REWORKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REWORKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REWORKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REWORKDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REWORKDETAIL actions', async () => {
      const expectedActions = [
        {
