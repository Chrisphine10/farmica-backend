...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VARIABLEDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_VARIABLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VARIABLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VARIABLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VARIABLEDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VARIABLEDATA actions', async () => {
      const expectedActions = [
        {
