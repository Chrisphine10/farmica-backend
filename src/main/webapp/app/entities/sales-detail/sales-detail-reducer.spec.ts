...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESDETAIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESDETAIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESDETAIL actions', async () => {
      const expectedActions = [
        {
