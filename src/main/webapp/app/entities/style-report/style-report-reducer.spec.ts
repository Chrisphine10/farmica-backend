...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STYLEREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_STYLEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STYLEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STYLEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STYLEREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STYLEREPORT actions', async () => {
      const expectedActions = [
        {
