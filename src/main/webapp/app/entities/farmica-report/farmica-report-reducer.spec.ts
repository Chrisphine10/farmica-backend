...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FARMICAREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FARMICAREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FARMICAREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FARMICAREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FARMICAREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FARMICAREPORT actions', async () => {
      const expectedActions = [
        {
